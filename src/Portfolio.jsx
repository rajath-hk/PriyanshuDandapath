    ...
    return (
        ...
        `}
            ...
            <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-auto">
                <div className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-slate-900/50 backdrop-blur-2xl border border-white/10 shadow-2xl hover:scale-105 transition-transform duration-300 ring-1 ring-white/5">
                    {['About', 'Experience', 'Work', 'Contact'].map((item) => (
                        <button
                            key={item}
                            onClick={() => scrollToSection(item.toLowerCase())}
                            className="px-4 py-2 rounded-xl text-sm font-bold text-slate-300 hover:bg-white/10 hover:text-white transition-all active:scale-95"
                        >
                            {item}
                        </button>
                    ))}
                    ...
                    <button
                        ...
                        className="px-4 py-2 rounded-xl bg-purple-600 text-white font-bold text-sm shadow-lg hover:bg-purple-500 transition-all active:scale-95"
                    >
                        Hire Me
                    </button>
                </div>
