...
const Portfolio = () => {
    ...
    const portfolioItems = {
        ...
        motionGraphics: [
            { title: 'Motion Graphics Short 1', type: 'short', videoId: 'VVOVSyZuNAM' },
            { title: 'Motion Graphics Short 2', type: 'short', videoId: '9qDAw8fE5Q0' },
            { title: 'Motion Graphics Short 3', type: 'short', videoId: '2VFJNTEjmTQ' },
            { title: 'Motion Graphics Short 3', type: 'short', videoId: '9VNqKz8nhq4' }
        ],
        youtube: [
